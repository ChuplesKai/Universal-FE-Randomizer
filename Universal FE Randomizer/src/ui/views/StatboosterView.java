...
public class StatboosterView extends YuneView<StatboosterOptions> {
     ...
     * Constructor
     ****************************************************************/
    public StatboosterView(Composite parent, GameType type) {
        super(parent, type);
    }
    ...
    public String getGroupTitle() {
        return "Stat Booster Item Randomization";
    }
    ...
    public String getGroupTooltip() {
        return "Change the stats granted by Stat Booster items.";
    }
    ...
    /*****************************************************************
     * getOptions - get the options object back with user input
     ****************************************************************/
    @Override

...
public class GBAPRFMaker
{
    ...
    private static Map<String, GBAFEWeaponDto> createPRFBaseMap()
    {
        ...
        newWeapMap.put("Foil", new GBAFEWeaponDto("Foil","Foil","",WeaponType.NOT_A_WEAPON,3,3,85,10,1,1,45,0,0) ); 
        newWeapMap.put("Blade", new GBAFEWeaponDto("Blade","Blade","",WeaponType.NOT_A_WEAPON,5,6,95,0,1,1,40,0,0) );
        newWeapMap.put("Brand", new GBAFEWeaponDto("Brand","Brand","",WeaponType.NOT_A_WEAPON,7,9,70,0,1,2,35,0,0) );
        newWeapMap.put("Pike", new GBAFEWeaponDto("Pike","Pike","",WeaponType.NOT_A_WEAPON,4,3,85,5,1,1,45,0,0) ); 
        newWeapMap.put("Spear", new GBAFEWeaponDto("Spear","Spear","",WeaponType.NOT_A_WEAPON,4,6,60,0,1,2,40,0,0) );
        newWeapMap.put("Lance", new GBAFEWeaponDto("Lance","Lance","",WeaponType.NOT_A_WEAPON,10,9,65,0,1,1,35,0,0) );
        newWeapMap.put("Cleaver", new GBAFEWeaponDto("Cleaver","Cleaver","",WeaponType.NOT_A_WEAPON,5,6,70,15,1,1,45,0,0) );
        newWeapMap.put("Handax", new GBAFEWeaponDto("Handax","Handax","",WeaponType.NOT_A_WEAPON,5,9,65,0,1,2,40,0,0) );
        newWeapMap.put("Hammer", new GBAFEWeaponDto("Hammer","Hammer","",WeaponType.NOT_A_WEAPON,12,12,60,0,1,1,35,0,0) ); 
        newWeapMap.put("Bow", new GBAFEWeaponDto("Bow","Bow","",WeaponType.NOT_A_WEAPON,3,3,85,0,2,2,45,0,0) );
        newWeapMap.put("Longbow", new GBAFEWeaponDto("Longbow","Longbow","",WeaponType.NOT_A_WEAPON,4,6,65,0,2,3,35,0,0) );
        newWeapMap.put("Cantrip", new GBAFEWeaponDto("Cantrip","Cantrip","",WeaponType.NOT_A_WEAPON,4,3,90,0,1,2,40,0,0) );
        newWeapMap.put("Spell", new GBAFEWeaponDto("Spell","Spell","",WeaponType.NOT_A_WEAPON,7,6,70,10,1,2,35,0,0) ); 
        newWeapMap.put("Flare", new GBAFEWeaponDto("Flare","Flare","",WeaponType.NOT_A_WEAPON,2,3,85,15,1,2,45,0,0) );
        newWeapMap.put("Scour", new GBAFEWeaponDto("Scour","Scour","",WeaponType.NOT_A_WEAPON,4,3,75,20,1,2,40,0,0) ); 
        newWeapMap.put("Eclipse", new GBAFEWeaponDto("Eclipse","Eclipse","",WeaponType.NOT_A_WEAPON,5,3,65,0,1,2,40,0,0) ); 
        newWeapMap.put("Shard", new GBAFEWeaponDto("Shard","Shard","",WeaponType.NOT_A_WEAPON,7,6,55,10,1,3,35,0,0) );
        return newWeapMap;
    }
     ...
     ****************************************************************/
    public static GBAFEWeaponDto makePRF( GBAFECharacterData character, int charIndex, ClassDataLoader classData, Random rng )
    {

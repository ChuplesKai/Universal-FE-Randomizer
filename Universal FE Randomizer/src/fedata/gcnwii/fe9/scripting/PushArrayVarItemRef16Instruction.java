...
public class PushArrayVarItemRef16Instruction extends ScriptInstruction {
	...
	public String displayString() {
		return "PUSH_ARRAY_VAR_ITEM_REF_16 (0x" + Integer.toHexString(arrayVariable) + ")";
	}

	@Override
	public byte[] rawBytes() {
		return new byte[] {0xA, (byte)((arrayVariable & 0xFF00) >> 8), (byte)(arrayVariable & 0xFF)};
	}
	...
	public ScriptInstruction createWithArgs(byte[] args, GCNCMBFileHandler handler) {
		return new PushArrayVarItemRef16Instruction(args);
	}
